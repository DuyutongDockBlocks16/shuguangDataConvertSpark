-- 命名规范：小驼峰，关键字后面+"_col"
CREATE TABLE IF NOT EXISTS shuguang.shuguang_ods_game_stateHero_d
(
...
--     date             	STRING COMMENT '对局日期',
    ...
    equipIDRecommend    ARRAY<INT> COMMENT '业务提供的装备列表',
...
LOAD DATA INPATH '/staging/shuguang/rec_parse/${YEAR}/${MONTH}/${DAY}/ods_stateHero'
    OVERWRITE INTO TABLE shuguang.shuguang_ods_game_stateHero_d
