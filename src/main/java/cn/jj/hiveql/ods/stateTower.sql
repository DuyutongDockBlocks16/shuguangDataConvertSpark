-- 命名规范：小驼峰，关键字后面+"_col"
CREATE TABLE IF NOT EXISTS shuguang.shuguang_ods_game_stateTower_d
(
...
LOAD DATA INPATH '/staging/shuguang/rec_parse/${YEAR}/${MONTH}/${DAY}/ods_stateTower'
    OVERWRITE INTO TABLE shuguang.shuguang_ods_game_stateTower_d
