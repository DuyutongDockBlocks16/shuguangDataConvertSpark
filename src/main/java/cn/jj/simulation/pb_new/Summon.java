...
public final class Summon {
  ...
  public interface MsgSummonOrBuilder extends
     ...
     * </pre>
     *
     * <code>repeated .shuguang.MsgBuffState buffState = 15;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BUFFSTATE_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < buffState_.size(); i++) {
        output.writeMessage(15, buffState_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < buffState_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, buffState_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < delbuffs_.size(); i++) {
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.simulation.pb_new.Summon.MsgSummon.newBuilder()
      private Builder() {
  ...
  static {
    String[] descriptorData = {
      "\n\014summon.proto\022\010shuguang\032\tcmd.proto\"\237\002\n\t" +
      ...
      "\n\n\002hp\030\006 \001(\005\022\r\n\005hpMax\030\007 \001(\005\022\013\n\003atk\030\010 \001(\005\022" +
      "\013\n\003def\030\t \001(\005\022\022\n\nisVisiable\030\n \001(\010\022\020\n\010targ" +
      "etId\030\013 \001(\003\022\020\n\010atkRange\030\014 \001(\005\022\020\n\010summonId" +
      "\030\r \001(\005\022\017\n\007ownerId\030\016 \001(\005\022)\n\tbuffState\030\017 \003" +
      "(\0132\026.shuguang.MsgBuffState\022\021\n\010delbuffs\030\232" +
    ...
    internal_static_shuguang_MsgSummon_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_shuguang_MsgSummon_descriptor,
        new String[] { "Id", "CampId", "Type", "PosX", "PosY", "Hp", "HpMax", "Atk", "Def", "IsVisiable", "TargetId", "AtkRange", "SummonId", "OwnerId", "BuffState", "Delbuffs", });
    Cmd.getDescriptor();
  }
