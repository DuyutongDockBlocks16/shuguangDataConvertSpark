...
public final class Hero {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.VInt2D.newBuilder()
      private Builder() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgSkillRangeData.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgSkillRange.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgAbilityState.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgActorState.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  public interface MsgHeroOrBuilder extends
     ...
     * </pre>
     *
     * <code>repeated int32 equipIDRecommend = 7;</code>
     * @return A list containing the equipIDRecommend.
     */
    java.util.List<Integer> getEquipIDRecommendList();
    /**
     * <pre>
     *（业务提供的装备列表）
     * </pre>
     *
     * <code>repeated int32 equipIDRecommend = 7;</code>
     * @return The count of equipIDRecommend.
     */
    int getEquipIDRecommendCount();
    /**
     * <pre>
     *（业务提供的装备列表）
     * </pre>
     ...
     * <code>repeated int32 equipIDRecommend = 7;</code>
     * @param index The index of the element to return.
     * @return The equipIDRecommend at the given index.
     */
    int getEquipIDRecommend(int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private MsgHero() {
      ...
      equipIDRecommend_ = emptyIntList();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                equipIDRecommend_ = newIntList();
                mutable_bitField0_ |= 0x00000008;
              }
              equipIDRecommend_.addInt(input.readInt32());
              break;
            }
            case 58: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000008) != 0)) {
          equipIDRecommend_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000010) != 0)) {
    ...
    public static final int EQUIPIDRECOMMEND_FIELD_NUMBER = 7;
    private com.google.protobuf.Internal.IntList equipIDRecommend_;
    /**
     * <pre>
     *（业务提供的装备列表）
     * </pre>
    ...
    @Override
    public java.util.List<Integer>
        getEquipIDRecommendList() {
      return equipIDRecommend_;
    }
    /**
     * <pre>
     *（业务提供的装备列表）
     ...
     * @return The count of equipIDRecommend.
     */
    public int getEquipIDRecommendCount() {
      return equipIDRecommend_.size();
    }
    /**
     * <pre>
     *（业务提供的装备列表）
     ...
     * @return The equipIDRecommend at the given index.
     */
    public int getEquipIDRecommend(int index) {
      return equipIDRecommend_.getInt(index);
    }
    private int equipIDRecommendMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getEquipIDRecommendList().size() > 0) {
        output.writeUInt32NoTag(58);
        output.writeUInt32NoTag(equipIDRecommendMemoizedSerializedSize);
      }
      for (int i = 0; i < equipIDRecommend_.size(); i++) {
        output.writeInt32NoTag(equipIDRecommend_.getInt(i));
      }
      if (heroId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < equipIDRecommend_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(equipIDRecommend_.getInt(i));
        }
        size += dataSize;
        if (!getEquipIDRecommendList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        equipIDRecommendMemoizedSerializedSize = dataSize;
      }
      if (heroId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final Object obj) {
      ...
      if (!getEquipIDRecommendList()
          .equals(other.getEquipIDRecommendList())) return false;
      if (getHeroId()
    ...
    public int hashCode() {
      ...
      if (getEquipIDRecommendCount() > 0) {
        hash = (37 * hash) + EQUIPIDRECOMMEND_FIELD_NUMBER;
        hash = (53 * hash) + getEquipIDRecommendList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgHero.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public MsgHero buildPartial() {
        ...
        if (((bitField0_ & 0x00000008) != 0)) {
          equipIDRecommend_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000008);
        }
        result.equipIDRecommend_ = equipIDRecommend_;
      ...
      public Builder mergeFrom(MsgHero other) {
        ...
        if (!other.equipIDRecommend_.isEmpty()) {
          if (equipIDRecommend_.isEmpty()) {
            equipIDRecommend_ = other.equipIDRecommend_;
            bitField0_ = (bitField0_ & ~0x00000008);
          } else {
            ensureEquipIDRecommendIsMutable();
            equipIDRecommend_.addAll(other.equipIDRecommend_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList equipIDRecommend_ = emptyIntList();
      private void ensureEquipIDRecommendIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          equipIDRecommend_ = mutableCopy(equipIDRecommend_);
          bitField0_ |= 0x00000008;
         }
      }
      /**
      ...
      public java.util.List<Integer>
          getEquipIDRecommendList() {
        return ((bitField0_ & 0x00000008) != 0) ?
                 java.util.Collections.unmodifiableList(equipIDRecommend_) : equipIDRecommend_;
      }
      /**
       * <pre>
       *（业务提供的装备列表）
       ...
       * <code>repeated int32 equipIDRecommend = 7;</code>
       * @param index The index to set the value at.
       * @param value The equipIDRecommend to set.
       * @return This builder for chaining.
       */
      public Builder setEquipIDRecommend(
          int index, int value) {
        ensureEquipIDRecommendIsMutable();
        equipIDRecommend_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       ...
       *
       * <code>repeated int32 equipIDRecommend = 7;</code>
       * @param value The equipIDRecommend to add.
       * @return This builder for chaining.
       */
      public Builder addEquipIDRecommend(int value) {
        ensureEquipIDRecommendIsMutable();
        equipIDRecommend_.addInt(value);
        onChanged();
        return this;
      }
      /**
       ...
       *
       * <code>repeated int32 equipIDRecommend = 7;</code>
       * @param values The equipIDRecommend to add.
       * @return This builder for chaining.
       */
      public Builder addAllEquipIDRecommend(
          Iterable<? extends Integer> values) {
        ensureEquipIDRecommendIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, equipIDRecommend_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearEquipIDRecommend() {
        equipIDRecommend_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000008);
        onChanged();
        return this;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using cn.jj.shuguang.pb.Hero.MsgResultHero.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      "c\030+ \001(\005\022\021\n\tshieldAll\030, \001(\005\022\024\n\014shieldPhyM" +
      "ax\030- \001(\005\022\024\n\014shieldMgcMax\030. \001(\005\022\024\n\014shield" +
      "AllMax\030/ \001(\005\022\037\n\027headIconLockOnTargetIid\030" +
      "0 \001(\003\022\026\n\016chaseTargetIid\0301 \001(\005\022\023\n\013isChase" +
      "Move\0302 \001(\010\022\027\n\017isAutoAttacking\0303 \001(\010\022\027\n\017l" +
      "ockOnTargetIid\0304 \001(\005\022\016\n\006isDead\0305 \001(\010\022\026\n\r" +
      "delcurSkillID\030\254N \003(\005\022\023\n\ndelexState\030\270N \003(" +
      "\005\"\341\002\n\007MsgHero\022\n\n\002Id\030\001 \001(\003\022+\n\nactorState\030" +
      "\002 \001(\0132\027.shuguang.MsgActorState\022/\n\014abilit" +
      "yState\030\003 \003(\0132\031.shuguang.MsgAbilityState\022" +
      "\"\n\010commands\030\004 \003(\0132\020.shuguang.MsgCmd\022\021\n\tb" +
      "ServerAI\030\005 \001(\010\022\021\n\tequiptIDs\030\006 \003(\005\022\030\n\020equ" +
      "ipIDRecommend\030\007 \003(\005\022\016\n\006heroId\030\010 \001(\005\022\016\n\006r" +
      "aceId\030\t \001(\005\022\017\n\007account\030\n \001(\003\022\r\n\005level\030\013 " +
      "\001(\005\022\013\n\003elo\030\014 \001(\005\022\r\n\005score\030\r \001(\005\022\022\n\ndiffi" +
      "culty\030\016 \001(\005\022\030\n\017delabilityState\030\224N \003(\003\"Z\n" +
      "\rMsgResultHero\022\n\n\002Id\030\001 \001(\003\022(\n\010commands\030\002" +
      " \003(\0132\026.shuguang.ResultMsgCmd\022\023\n\013debugStr" +
      "ing\030\003 \001(\014*\344\001\n\020MsgSkillSlotType\022\023\n\017SKILL_" +
      "SLOT_NONE\020\000\022\034\n\030SKILL_SLOT_NORMAL_ATTACK\020" +
      "\001\022\024\n\020SKILL_SLOT_SKLL1\020\002\022\024\n\020SKILL_SLOT_SK" +
      "LL2\020\003\022\024\n\020SKILL_SLOT_SKLL3\020\004\022\024\n\020SKILL_SLO" +
      "T_SKLL4\020\005\022\026\n\022SKILL_SLOT_PASSIVE\020\006\022\027\n\023SKI" +
      "LL_SLOT_SUMMONER\020\007\022\024\n\020SKILL_SLOT_EQUIP\020\010" +
      "*\221\001\n\022MsgSkillTargetType\022\025\n\021SKILL_TARGET_" +
      "NONE\020\000\022\025\n\021SKILL_TARGET_UNIT\020\001\022\031\n\025SKILL_T" +
      "ARGET_DIRCTION\020\002\022\031\n\025SKILL_TARGET_POSITIO" +
      "N\020\003\022\027\n\023SKILL_NORMAL_ATTACK\020\004B\023\n\021cn.jj.sh" +
      "uguang.pbb\006proto3"
    };
