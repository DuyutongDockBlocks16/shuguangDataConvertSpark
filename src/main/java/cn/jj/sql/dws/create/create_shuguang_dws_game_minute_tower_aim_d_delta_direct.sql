...
-- 	展示方式：报表
-- 	问题：目前数据支撑不了伤害的统计；
drop table if exists shuguang.shuguang_dws_game_minute_tower_aim_d_delta_direct;
CREATE TABLE IF NOT EXISTS shuguang.shuguang_dws_game_minute_tower_aim_d_delta_direct
(
    -- 主键（自然键）
...
--     tower end
    ...
    COMMENT '描述每局每个英雄每分钟被塔瞄准的次数和。数据来源自Spark任务直接加工数据'
