...
-- 	展示方式：报表
drop table if exists shuguang.shuguang_dws_game_minute_tp_d_delta_direct;
CREATE TABLE IF NOT EXISTS shuguang.shuguang_dws_game_minute_tp_d_delta_direct
(
--     主键
