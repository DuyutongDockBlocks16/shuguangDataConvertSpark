...
-- 	展示方式：报表
drop table if exists shuguang.shuguang_dws_game_second_tp_d_delta_direct;
CREATE TABLE IF NOT EXISTS shuguang.shuguang_dws_game_second_tp_d_delta_direct
(
--     主键
...
--     度量
    ...
    COMMENT '描述每次tp操作的累加事实，粒度为每秒tp操作聚合。主要维度有阵营、玩家类型（AI或玩家）、局内时间、英雄、职业、状态（血量蓝量当前比例）、地图位置，主要度量有tp触发次数等'
