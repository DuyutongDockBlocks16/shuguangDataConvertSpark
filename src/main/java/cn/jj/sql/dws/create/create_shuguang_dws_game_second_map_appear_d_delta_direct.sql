...
-- 命名规范：小驼峰，关键字后面+"_col"
-- 属性注释参照来源表
drop table if exists shuguang.shuguang_dws_game_second_map_appear_d_delta_direct;
CREATE TABLE IF NOT EXISTS shuguang.shuguang_dws_game_second_map_appear_d_delta_direct
(
    -- 主键（自然键）
...
--     度量
    ...
    COMMENT '描述地图不同区域每秒钟出现次数。数据来源自Spark任务直接加工数据'
